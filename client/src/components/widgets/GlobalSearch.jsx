...
function GlobalSearch({ searchTerm, setSearchTerm, showSuggestions, setShowSuggestions }) {
  ...
  // Derived state: only show suggestions if active, searching, and suggestions found
  const isSuggestionsVisible = showSuggestions && searchTerm && suggestions?.length > 0;
