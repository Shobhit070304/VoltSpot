    ...
    <div className="min-h-screen bg-midnight text-white flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10 animate-slide-up">
        <div className="text-center mb-8">
          ...
          <p className="text-[13px] text-slate-400 font-medium">Enter your details to access your account.</p>
        </div>
        ...
        <div className="glass-panel p-8 border-white/5">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="btn-primary w-full flex items-center justify-center gap-2 py-3 text-[11px] font-bold uppercase tracking-widest !rounded-xl mt-2"
            >
              {isLoading ? (
